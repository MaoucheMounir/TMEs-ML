...
def perceptron_grad(w,x,y):
    ...
    # Ce commentaire est vrai pour la logistic loss et la hinge loss squared. Pour la hinge loss normale comme ici, on va juste décaler la frontière pour qu'elle soit plus proche du point
